...
class HEMLOCK(object):
    ...
    WPN_DESC = FRONTEND.WPN_HEMLOCK_DESC
    WPN_LONGDESC = FRONTEND.WPN_HEMLOCK_LONGDESC
    WPN_NAME = FRONTEND.WPN_HEMLOCK_NAME
...
class SMR(object):
    ...
    MDL_FOLDER = "\auto_rocket_launcher_ARL\\"
...
class ARCHER(object):
    ...
    MDL_FOLDER = "\shoulder_rocket_SRAM\\"
...
class PARTICLEACCELERATOR(object):
    ...
    MDL_FOLDER = "\titan_particle_accelerator\\"
    MDL_V1_1P = [
...
class RAILGUN(object):
    ...
    MDL_FOLDER1 = "\atpov_titan_sniper_rifle\\"
    MDL_FOLDER2 = "\titan_sniper_rifle\\"
...
class THERMITECANNON(object):
    ...
    MDL_FOLDER = "\titan_thermite_launcher\\"
...
class XO16(object):
    MDL_FILE_1P = "atpov_xotbr16.mdl"
    MDL_FILE_3P = "w_xotbr16.mdl"
    MDL_FOLDER = r"\titan_xo16_shorty\\"
    MDL_V1_1P = [
