...
from lib.core.enums import TEXTURE
...
class ALTERNATOR(object):
    ...
    VTF_1P_AMBIENTOCC = "{0}_{1}.vtf".format(MATERIAL_1P_NAME_MODDED, TEXTURE.AMBIENTOCC)
    VTF_1P_BASE = "{0}_{1}.vtf".format(MATERIAL_1P_NAME_MODDED, TEXTURE.BASE)
    VTF_1P_BASE2 = "{0}_{1}.vtf".format(MATERIAL_1P_NAME_MODDED, TEXTURE.BASE2)
    VTF_1P_BLENDMODULATE = "{0}_{1}.vtf".format(MATERIAL_1P_NAME_MODDED, TEXTURE.BLENDMODULATE)
    VTF_1P_BUMP = "{0}_{1}.vtf".format(MATERIAL_1P_NAME_MODDED, TEXTURE.BUMP)
    VTF_1P_CORNEA = "{0}_{1}.vtf".format(MATERIAL_1P_NAME_MODDED, TEXTURE.CORNEA)
    VTF_1P_DETAIL = "{0}_{1}.vtf".format(MATERIAL_1P_NAME_MODDED, TEXTURE.DETAIL)
    VTF_1P_ENV = "{0}_{1}.vtf".format(MATERIAL_1P_NAME_MODDED, TEXTURE.ENV)
    VTF_1P_ENVMASK = "{0}_{1}.vtf".format(MATERIAL_1P_NAME_MODDED, TEXTURE.ENVMASK)
    VTF_1P_PHONGEXPONENT = "{0}_{1}.vtf".format(MATERIAL_1P_NAME_MODDED, TEXTURE.PHONGEXPONENT)
    VTF_1P_SELFILLUM = "{0}_{1}.vtf".format(MATERIAL_1P_NAME_MODDED, TEXTURE.SELFILLUM)
...
class CAR(object):
    ...
    # FRONTEND
    WPN_DESC = FRONTEND.WPN_CAR_DESC
    WPN_LONGDESC = FRONTEND.WPN_CAR_LONGDESC
    WPN_NAME = FRONTEND.WPN_CAR_NAME
    WPN_NAME_SHORT = FRONTEND.WPN_CAR_NAME_SHORT
    WPN_CLASS = FRONTEND.WPN_CAR_CLASS
    WPN_TYPE = FRONTEND.WPN_CAR_TYPE
...
class MK6(object):
    ...
    # FRONTEND
    WPN_DESC = FRONTEND.WPN_MK6_DESC
    WPN_LONGDESC = FRONTEND.WPN_MK6_LONGDESC
    WPN_NAME = FRONTEND.WPN_MK6_NAME
    WPN_NAME_SHORT = FRONTEND.WPN_MK6_NAME_SHORT
    WPN_CLASS = FRONTEND.WPN_MK6_CLASS
    WPN_TYPE = FRONTEND.WPN_MK6_TYPE


class WINGMAN(object):
    # 1P - First person view
    ...
    # FRONTEND
    WPN_DESC = FRONTEND.WPN_WINGMAN_DESC
    WPN_LONGDESC = FRONTEND.WPN_WINGMAN_LONGDESC
    WPN_NAME = FRONTEND.WPN_WINGMAN_NAME
    WPN_NAME_SHORT = FRONTEND.WPN_WINGMAN_NAME_SHORT
    WPN_CLASS = FRONTEND.WPN_WINGMAN_CLASS
    WPN_TYPE = FRONTEND.WPN_WINGMAN_TYPE
...
class SPLITTER(object):
    ...
    # FRONTEND
    WPN_DESC = FRONTEND.WPN_SPLITTER_DESC
    WPN_LONGDESC = FRONTEND.WPN_SPLITTER_LONGDESC
    WPN_NAME = FRONTEND.WPN_SPLITTER_NAME
    WPN_NAME_SHORT = FRONTEND.WPN_SPLITTER_NAME_SHORT
    WPN_CLASS = FRONTEND.WPN_SPLITTER_CLASS
    WPN_TYPE = FRONTEND.WPN_SPLITTER_TYPE
...
class PREDATOR(object):
    ...
    # FRONTEND
    WPN_DESC = FRONTEND.WPN_PREDATOR_DESC
    WPN_LONGDESC = FRONTEND.WPN_PREDATOR_LONGDESC
    WPN_NAME = FRONTEND.WPN_PREDATOR_NAME
    WPN_NAME_SHORT = FRONTEND.WPN_PREDATOR_NAME_SHORT
    WPN_CLASS = FRONTEND.WPN_PREDATOR_CLASS
    WPN_TYPE = FRONTEND.WPN_PREDATOR_TYPE
...
class T203(object):
    ...
    # FRONTEND
    WPN_DESC = FRONTEND.WPN_T203_DESC
    WPN_LONGDESC = FRONTEND.WPN_T203_LONGDESC
    WPN_NAME = FRONTEND.WPN_T203_NAME
    WPN_NAME_SHORT = FRONTEND.WPN_T203_NAME_SHORT
    WPN_CLASS = FRONTEND.WPN_T203_CLASS
    WPN_TYPE = FRONTEND.WPN_T203_TYPE
...
class CHAINGUN(object):
    ...
    # FRONTEND
    WPN_DESC = FRONTEND.WPN_CHAINGUN_DESC
    WPN_LONGDESC = FRONTEND.WPN_CHAINGUN_LONGDESC
    WPN_NAME = FRONTEND.WPN_CHAINGUN_NAME
    WPN_NAME_SHORT = FRONTEND.WPN_CHAINGUN_NAME_SHORT
    WPN_CLASS = FRONTEND.WPN_CHAINGUN_CLASS
    WPN_TYPE = FRONTEND.WPN_CHAINGUN_TYPE
